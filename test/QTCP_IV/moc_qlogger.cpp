...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QLogger__QLoggerWriter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QLogger__QLoggerWriter_t qt_meta_stringdata_QLogger__QLoggerWriter = {
    {
QT_MOC_LITERAL(0, 0, 22) // "QLogger::QLoggerWriter"

    },
    "QLogger::QLoggerWriter"
};
...
QT_INIT_METAOBJECT const QMetaObject QLogger::QLoggerWriter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QLogger__QLoggerWriter.data,
    qt_meta_data_QLogger__QLoggerWriter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QLogger::QLoggerWriter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QLogger__QLoggerWriter.stringdata0))
