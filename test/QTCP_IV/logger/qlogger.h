...
*/
            QMutex mutex;
            QMutex mutexDestination;

            bool removeDestination(QString module);
            bool checkDestination(QString module);
            void getListDestination(QList<QString> *listDestination);
            int numListDestination();
