...
class GetOffsetFromSocketUDP:
    ...
    def subprocess_get_offset_from_UDP(self, share_buffer_offset_queue):
        while not self.isExitApp:
            ...
            if received_bytes <12:
                ...
                if crc32cal != crc32:
                    ...
                    continue
                Data_final = (offset_x, offset_y)
                
                share_buffer_offset_queue.put(Data_final)
