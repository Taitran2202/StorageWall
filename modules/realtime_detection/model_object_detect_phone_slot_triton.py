...
class Object_Detection_YOLOv8(YOLOv8_Triton):
    ...
    def post_process(self, image, bboxes, positionToDetect):
        ...
        for phone in phone_list:
            ...
            if overlap_percentage_center > 25:
        ...
        msg = "overlap_percentage_center = " + str(overlap_percentage_center) + "%"
        ...
        return result, debug_img, position_phone_center
    ...
    def run(self, image_path, positionToDetect):
        ...
        try:
            ...
            result, debug_img, position_phone_center = self.post_process(original_image, object_list, positionToDetect)
...
if __name__ == "__main__":
    ...
    threshold = 0.7
    model = Object_Detection_YOLOv8(model_path, labelmap_path, threshold)
