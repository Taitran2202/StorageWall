...
# Inits
CONF_THRESHOLD = 0.8
CLASSES = ['phone', 'empty_slot'] # yaml_load(check_yaml("coco128.yaml"))["names"]
...
class PhoneSlotObjectDetector:
    ...
    def post_process(self, object_list, debug_img, positionToDetect):
    ...
    def run(self, image_path, positionToDetect):
        ...
        try:
            ...
            result, debug_img = self.post_process(object_list, debug_img, positionToDetect)
...
if __name__ == '__main__':
    ...
    image_path = "/home/greystone/LongVu/Projects/PhoneBot/test/41AAACJ7.jpg"
    model_object_phone_slot_weight_path = '/home/greystone/LongVu/Projects/PhoneBot/model_openvino/model_detect_has_phone_or_not_yolo_v8_object_openvino.onnx'
    ml_debug_path = "/home/greystone/LongVu/Projects/PhoneBot/image_debug"
